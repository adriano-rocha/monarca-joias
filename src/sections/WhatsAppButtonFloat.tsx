...
export function WhatsAppButtonFloat() {
  return (
    ...
    >
      ...
      {/* Botão */}
      <div className="bg-green-500 hover:bg-green-600 rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 animate-pulse hover:animate-none flex items-center justify-center w-16 h-16">
        <svg
